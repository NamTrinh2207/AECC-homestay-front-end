        ...
        if (windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if ($('.do-sticky').length < 1) {
                    $('.logo2 img').attr('src', 'https://p1.hiclipart.com/preview/524/125/300/family-tree-design-logo-homestay-accommodation-bed-and-breakfast-house-green-text-png-clipart-thumbnail.jpg');
                }
            } else {
